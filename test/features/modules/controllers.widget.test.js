...
describe('controllers.widget', function () {
  ...
  describe('controllers.widget.getCreateForm', function () {
    ...
    it('getCreateForm should run res.serverError if formMiddleware return error', function (done) {
      ...
      var oldFN = we.plugins['we-plugin-widget'].widgetTypes.html.formMiddleware;
      we.plugins['we-plugin-widget'].widgetTypes.html.formMiddleware = function(req, res, next) {
      ...
      var res = { locals: { }, serverError: function() {
        we.plugins['we-plugin-widget'].widgetTypes.html.formMiddleware = oldFN;
        done();
      }};
